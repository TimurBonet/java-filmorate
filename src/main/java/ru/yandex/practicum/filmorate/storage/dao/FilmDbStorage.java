...
public class FilmDbStorage implements FilmStorage {
    ...
    public List<Film> findAll() {
        String sqlQuery = "SELECT F.*," +
                ...
                "FROM FILMS AS F" +
                "LEFT JOIN PUBLIC.MPA M ON M.MPA_RATING_ID = F.MPA_RATING_ID" +
    ...
    public Optional<Film> findFilmById(Long id) {
        String sqlQuery = "SELECT F.*," +
                ...
                "LEFT JOIN PUBLIC.GENRE G ON GENRE_ID = FG.GENRE_ID" +
                "WHERE F.FILM_IF =  ?" +
                "GROUP by F.FILM_ID";
    ...
    public List<Film> getTopFilms(Integer count) {
        String sqlQuery = "SELECT F.*," +
                ...
                "LEFT JOIN PUBLIC.FILM_GENRE FG ON F.FILM_ID = FG.FILM_ID" +
                "LEFT JOIN PUBLIC.GENRE G ON GENRE_ID = FG.GENRE_ID" +
                "LEFT JOIN PUBLIC.FILM_LIKES FL ON F.FILM_ID = FL.FILM_ID " +
                "GROUP BY F.FILM_ID " +
    ...
    return MPA.builder()
            .mpaRatingId(resultSet.getLong("MPA_ID"))
            .name(resultSet.getString("NAME"))
            .build();
    }
    ...
    private void updateFilmGenresList(Film film){
        ...
        String sqlQuery = "INSERT INTO FILM_GENRE(FIL_ID,GENRE_ID) " +
                "VALUES(?,?)";
